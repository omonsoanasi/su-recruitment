                                            ...
                                            <div class="p-4">
                                                ...
                                                @else
                                                    ...
                                                    <form method="POST" action="{{ route('pnced.edcomments.store', $edrequistion) }}">
                                                        ...
                                                        <button type="submit" name="status" value="3" class="text-white bg-green-800 hover:bg-green-300 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" @if($edrequistion->status >= 4) disabled @endif>Approve</button>
                                                        <button type="submit" name="status" value="-3" class="text-white bg-red-900 hover:bg-green-300 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" @if($edrequistion->status >= 4) disabled @endif>Reject</button>
                                                    </form>
                                                    @endrole
                                                @endif
                                                <hr>
