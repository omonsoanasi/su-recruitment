                        ...
                        <nav class = "flex px-5 py-3 text-gray-700  rounded-lg bg-gray-50 dark:bg-[#1E293B] " aria-label="Breadcrumb">
                            <ol class = "inline-flex items-center space-x-1 md:space-x-3">
                                <li class = "inline-flex items-center">
                                    <a href="{{ route('pnced.index') }}" class = "inline-flex items-center text-sm font-medium text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white">
                                ...
                                <li>
                                    <div class = "flex items-center">
                                        ...
                                        <a href="#" class = "ml-1 text-sm font-medium text-gray-700 hover:text-gray-900 md:ml-2 dark:text-gray-400 dark:hover:text-white">Requisition Request</a>
                                    </div>
                                </li>
                            </ol>
                        </nav>
                                ...
                                <div class="flex flex-col justify-start">
                                    <div class="flex justify-between items-center w-full">
                                        <div class="text-lg font-semibold text-bookmark-blue flex space-x-1 items-center mb-2">
                                            ...
                                            <span>{{ $edrequistion->jobtitle }}</span>
                                        </div>
                                    ...
                                    <div class="text-sm text-gray-500 flex space-x-1 items-center mb-2">
                                        ...
                                        <span>{{ $edrequistion->campuslocation ? $edrequistion->campuslocation->name : 'No location set' }}</span>
                                    </div>
                                    <div class="grid grid-cols-3 gap-4">
                                        <div class="bg-white p-6 rounded-lg shadow-md flex items-center">
                                            ...
                                            <div>
                                                ...
                                                <p class="text-gray-600">{{ $edrequistion->jobtype->name }}</p>
                                            </div>
                                        </div>
                                        <div class="bg-white p-6 rounded-lg shadow-md flex items-center">
                                            <div class="mr-4">
                                            ...
                                            <div>
                                                ...
                                                <p class="text-gray-600">{{ number_format($edrequistion->approvedsalary, 2, '.', ',') }}</p>
                                            </div>
                                        </div>
                                        <div class="bg-white p-6 rounded-lg shadow-md flex items-center">
                                            <div class="mr-4">
                                            ...
                                            <div>
                                                ...
                                                <p class="text-gray-600">{{ $edrequistion->department->name }}</p>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="grid grid-cols-2">
                                            <div class="p-4">
                                                ...
                                                <div class="flex justify-between">
                                                    ...
                                                    <p class="text-gray-800 text-base">{{ $edrequistion->numberofvacancies }}</p>
                                                </div>
                                                <hr>
                                                <div class="flex justify-between">
                                                    <p class="text-gray-600 text-base font-bold">Number of Current Job Holders:</p>
                                                    <p class="text-gray-800 text-base">{{ $edrequistion->noofcurrentholders }}</p>
                                                </div>
                                                <hr>
                                                <div class="flex justify-between">
                                                    <p class="text-gray-600 text-base font-bold">Start Date:</p>
                                                    <p class="text-gray-800 text-base">{{ $edrequistion->startdate }}</p>
                                                </div>
                                                <hr>
                                                <div class="flex justify-between">
                                                    <p class="text-gray-600 text-base font-bold">Job Type:</p>
                                                    <p class="text-gray-800 text-base">{{ $edrequistion->statusofemployment }}</p>
                                                </div>
                                                <hr>
                                                <div class="flex justify-between">
                                                    <p class="text-gray-600 text-base font-bold">Reporting To:</p>
                                                    <p class="text-gray-800 text-base">{{ $edrequistion->reportingto }}</p>
                                                </div>
                                                <hr>
                                                <div class="flex justify-between">
                                                    <p class="text-gray-600 text-base font-bold">Advertise?
                                                        @if($edrequistion->advertise == 1)
                                                            <span class="text-emerald-600 font-semibold">Yes</span>
                                                        @else
                                                            <span class="text-red-800 font-semibold">No</span>
                                                        @endif
                                                    </p>
                                                    <p class="text-gray-800 text-base">{{ $edrequistion->advertjustification }}</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="flex w-full justify-center">
                                            <div class="p-4">
                                                ...
                                                <div class="bg-cyan-50 shadow-lg rounded-lg overflow-hidden mt-4">
                                                    ...
                                                    @foreach($bpcomments as $bpcomment)
                                                        <span> - Approved by: {{ $bpcomment->user->name }} </span><span> <strong> On: {{ \Carbon\Carbon::parse($bpcomment->updated_at)->format('Y-m-d') }}</strong> </span>
                                                    @endforeach
                                                </div>
                                                ...
                                                @if($edrequistion->status >= 4)
                                                    <div class="bg-cyan-20 shadow-lg rounded-lg overflow-hidden mt-4">
                                                        ...
                                                        @foreach($edcomments as $edcomment)
                                                            <span> - Approved by: {{ $edcomment->user->name }} </span><span> <strong> On: {{ \Carbon\Carbon::parse($edcomment->updated_at)->format('Y-m-d') }}</strong> </span>
                                                        @endforeach
                                                    </div>
                                                @else
                                                    @role('PnC Executive Director')
                                                    <form method="POST" action="{{ route('pnced.edcomments.store', $edrequistion) }}">
                                                        @csrf
                                                        <fieldset>
                                                            ...
                                                            <div class="shadow-md rounded px-8 pt-6 pb-8 mb-4 flex flex-col my-2 mt-3">
                                                                ...
                                                                <div class="-mx-3 md:flex mb-6">
                                                                    <div class="md:w-full px-3">
                                                                        ...
                                                                        <textarea id="editor" name="comment" rows="4" class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded py-3 px-4 disabled:opacity-70" id="comment" @if($edrequistion->status >= 2) readonly @endif >
                                                                        @foreach($edcomments as $edcomment)
                                                                                {!! $edcomment->comment !!}
                                                                            @endforeach
                                                                    </textarea>
                                                        ...
                                                        <input name="staff_requistion_forms_id" class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded py-3 px-4" id="staff_requistion_forms_id" type="hidden" value="{{ $edrequistion->id }}">
                                                        <button type="submit" class="text-white bg-green-800 hover:bg-green-300 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" @if($edrequistion->status >= 4) disabled @endif>Approve</button>
                                                        <button type="submit" class="text-white bg-red-900 hover:bg-green-300 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" @if($edrequistion->status >= 2) disabled @endif>Reject</button>
                                                    </form>
                                                    @endrole
                                                @endif
                                                <hr>
