                                ...
                                <li>
                                    <div class = "flex items-center">
                                        ...
                                        <a href="#" class = "ml-1 text-sm font-medium text-gray-700 hover:text-gray-900 md:ml-2 dark:text-gray-400 dark:hover:text-white">Job Title : <span class="font-bold text-xl">
                                            @foreach ($candidateoffers as $application)
                                        ...
                                        @foreach($candidateoffers as $candidateoffer)
                                            <tr class="border-b border-gray-200 dark:border-gray-700">
                                                <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap bg-gray-50 dark:text-white dark:bg-gray-800">
                                                    {{ $candidateoffer->applicantBasicInfo->title }} {{ $candidateoffer->applicantBasicInfo->firstname }} {{ $candidateoffer->applicantBasicInfo->lastname }}
                                                </th>
                                                <td class="px-6 py-4">
                                                    {{ $candidateoffer->staffRequistionForm->jobtitle }}
                                                </td>
                                                <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap bg-gray-50 dark:text-white dark:bg-gray-800">
                                                    {{ $candidateoffer->created_at }}
                                                </th>
                                                <td class="px-6 py-4">
                                                    @if($candidateoffer->responded == 1)
                                                ...
                                                <td class="px-6 py-4">
                                                    <div class="flex justify-end">
                                                        <div class="flex space-x-2">
                                                                <a href="{{ route('bpartner.candidateoffer.show', $candidateoffer->application_id) }}" class="px-4 py-2 bg-blue-500 hover:bg-blue-800 text-white rounded-md">Candidate Info/Cover Letter</a>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
