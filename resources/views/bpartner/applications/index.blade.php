                                            ...
                                            <tr class="border-b border-gray-200 dark:border-gray-700">
                                                ...
                                                <td class="px-6 py-4">
                                                    <div class="flex justify-end">
                                                        ...
                                                        <div class="flex space-x-2 p-2">
                                                            <a href="{{ route('bpartner.applicationshow.index', $publishedjob) }}" class="px-4 py-2 bg-blue-500 hover:bg-blue-800 text-white rounded-md">Interviews <br><span class="text-indigo-700 font-bold">({{ $publishedjob->applications->count() }})</span></a>
                                                        </div>
                                                        <div class="flex space-x-2 p-2">
                                                            <a href="{{ route('bpartner.applicationshow.index', $publishedjob) }}" class="px-4 py-2 bg-blue-500 hover:bg-blue-800 text-white rounded-md">Offered <br><span class="text-indigo-700 font-bold">({{ $publishedjob->applications->count() }})</span></a>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
