                                ...
                                <li>
                                    <div class = "flex items-center">
                                        ...
                                        <a href="#" class = "ml-1 text-sm font-medium text-gray-700 hover:text-gray-900 md:ml-2 dark:text-gray-400 dark:hover:text-white">Job Title : <span class="font-bold text-xl">
                                            @foreach ($interviewlists as $application)
                                        ...
                                        @foreach($interviewlists as $interviewlist)
                                            <tr class="border-b border-gray-200 dark:border-gray-700">
                                                <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap bg-gray-50 dark:text-white dark:bg-gray-800">
                                                    {{ $interviewlist->applicantBasicInfo->title }} {{ $interviewlist->applicantBasicInfo->firstname }} {{ $interviewlist->applicantBasicInfo->lastname }}
                                                </th>
                                                <td class="px-6 py-4">
                                                    {{ $interviewlist->staffRequistionForm->jobtitle }}
                                                </td>
                                                <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap bg-gray-50 dark:text-white dark:bg-gray-800">
                                                ...
                                                <td class="px-6 py-4">
                                                    <div class="flex justify-end">
                                                        <div class="flex space-x-2">
                                                                <a href="{{ route('bpartner.interviewlist.show', $interviewlist->application_id) }}" class="px-4 py-2 bg-blue-500 hover:bg-blue-800 text-white rounded-md">Candidate Info/Cover Letter</a>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
