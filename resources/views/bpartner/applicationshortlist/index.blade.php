                            ...
                            <div class="p-6 text-gray-900">
                                <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400 display" id="businessPartnerRequisitions">
                                        ...
                                        <tbody>
                                        @foreach($applicationshortlists as $applicationshortlist)
                                            <tr class="border-b border-gray-200 dark:border-gray-700">
                                                <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap bg-gray-50 dark:text-white dark:bg-gray-800">
                                                    {{ $applicationshortlist->applicantBasicInfo->title }} {{ $applicationshortlist->applicantBasicInfo->firstname }} {{ $applicationshortlist->applicantBasicInfo->lastname }}
                                                </th>
                                                <td class="px-6 py-4">
                                                    {{ $applicationshortlist->staffRequistionForm->jobtitle }}
                                                </td>
                                                <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap bg-gray-50 dark:text-white dark:bg-gray-800">
                                                    {{ $applicationshortlist->created_at }}
                                                </th>
                                                <td class="px-6 py-4">
                                                    {{ $applicationshortlist->longliststatus }}
                                                </td>
                                                <td class="px-6 py-4">
                                                    <div class="flex justify-end">
                                                        <div class="flex space-x-2">
                                                                <a href="{{ route('bpartner.applicationshortlist.show', $applicationshortlist->application_id) }}" class="px-4 py-2 bg-blue-500 hover:bg-blue-800 text-white rounded-md">Candidate Info/Cover Letter</a>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
