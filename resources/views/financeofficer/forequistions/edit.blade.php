                                            ...
                                            <div class="p-4">
                                                ...
                                                @else
                                                    ...
                                                    <form method="POST" action="{{ route('financeofficer.focomments.store', $forequistion) }}">
                                                        ...
                                                        <button type="submit" class="text-white bg-green-800 hover:bg-green-300 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" @if($forequistion->status >= 3) disabled @endif>Forward to PnC Executive Director (for approval)</button>
                                                        <button type="submit" class="text-white bg-red-900 hover:bg-green-300 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" @if($forequistion->status >= 2) disabled @endif>Reject</button>
                                                    </form>
                                                    @endrole
                                                @endif
                                                <hr>
