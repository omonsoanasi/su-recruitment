<x-welcome-layout>
    ...
    <div class="font-sans bg-white flex flex-col min-h-screen w-full">
        <div>
            ...
            <div class="max-w-7xl mx-auto bg-white shadow-lg relative z-20 md:block" style="margin-top: -320px; border-radius: 20px;">
                ...
                <section class="mx-auto max-w-7xl py-12">
                    <div class="flex flex-col max-w-6xl mx-auto">
                                ...
                                <div class="transition-all ease-in-out duration-1000 flex flex-col justify-center">
                                    <div slot="middle-left" class="max-w-2xl">
                                        <div class="flex flex-row">
                                            <div class="w-2/3 bg-orange-600 p-5 text-teal-100 flex justify-center items-center h-48 text-3xl font-black uppercase rounded-lg">
                                                {{ $vacancy->jobtitle }}</div>
                                            <div class="w-1/3 bg-teal-600 text-orange-100 p-5 flex flex-col justify-center items-center gap-2 rounded-lg">
                                                <p><strong>Type:</strong> {{ $vacancy->jobtype->name }}</p>
                                                <hr>
                                                <p><strong>Location:</strong> {{ $vacancy->campuslocation->name ?? 'Main Campus' }}</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        @endforeach
                        <div class="flex w-full md:flex-row justify-center items-center mx-auto">
                            @foreach($particulars as $index => $vacancy)
                                <div class="transition-all ease-in-out duration-1000 flex justify-center md:mr-2 w-full bg-gray-50 rounded-md mt-4 mx-auto">
                                    <div slot="bottom-left" class="w-full mr-3 bg-white rounded-md">
                                        <div class="p-5 shadow-md m-2 mt-4 bg-gray-50">
