                                            ...
                                            <div class="bg-gray-300 shadow-md rounded px-8 pt-6 pb-8 mb-4 flex flex-col my-2 mt-9">
                                                <div class="-mx-3 md:flex mb-6">
                                                    <div class="md:w-1/2 px-3 mb-6 md:mb-0">
                                                        <label class="block uppercase tracking-wide text-grey-darker text-xs font-bold mb-2" for="staff_requistion_form_id">
                                                            Job Title
                                                        </label>
                                                        <select id="staff_requistion_form_id" name="staff_requistion_form_id" class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-red rounded py-3 px-4 mb-3">
                                                            @foreach( $ownrequistions as $requistion )
                                                                <option value="{{ $requistion->id }}" {{ $interviewpanel->staff_requistion_form_id == $requistion->id ? 'selected' : (old('staff_requistion_form_id') == $requistion->id ? 'selected' : '') }}>
                                                                    {{ $requistion->jobtitle }}
                                                                </option>
                                                            @endforeach
                                                        </select>
                                                        @error('staff_requistion_form_id')
                                                        <span class="text-red-500 text-sm"> {{ $message }}</span>
                                                        @enderror
                                                    </div>
                                                    <div class="md:w-1/2 px-3">
                                                        <label class="block uppercase tracking-wide text-grey-darker text-xs font-bold mb-2" for="panelistname">
                                                            Full Name
                                                        </label>
                                                        <input name="panelistname" class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded py-3 px-4" id="panelistname" type="text" placeholder="John Doe" value="{{ $interviewpanel->panelistname ?? old('panelistname') }}">
                                                        @error('panelistname')
                                                        <span class="text-red-500 text-sm"> {{ $message }}</span>
                                                        @enderror
                                                    </div>
                                                ...
                                                <div class="-mx-3 md:flex mb-2">
                                                    <div class="md:w-1/2 px-3 mb-6 md:mb-0">
                                                        ...
                                                        <input name="panelistemail" class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded py-3 px-4" id="panelistemail" type="email" placeholder="email@address.com" value="{{ $interviewpanel->panelistemail ?? old('panelistemail') }}">
                                                    ...
                                                    <div class="md:w-1/2 px-3">
                                                        ...
                                                        <input name="panelistphonenumber" class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded py-3 px-4" id="panelistphonenumber" type="text" placeholder="phone number" value="{{ $interviewpanel->panelistphonenumber ?? old('panelistphonenumber') }}">
                                                ...
                                                <div class="-mx-3 md:flex mb-6">
                                                    <div class="md:w-1/2 px-3 mb-6 md:mb-0">
                                                        ...
                                                        <input name="interviewnotes" class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded py-3 px-4" id="interviewnotes" type="text" placeholder="short interview note " value="{{ $interviewpanel->interviewnotes ?? old('interviewnotes') }}">
                                                    ...
                                                    <div class="md:w-1/2 px-3 mb-6 md:mb-0">
                                                        ...
                                                        <input name="interviewdate" class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded py-3 px-4" id="interviewdate" type="date" placeholder="start date... " value="{{ $interviewpanel->interviewdate ?? old('panelistname') }}">
