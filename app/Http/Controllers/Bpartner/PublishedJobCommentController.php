...
class PublishedJobCommentController extends Controller
{
    /**
    ...
    public function store(Request $request)
    {
        ...
        $publishedJobComment = PublishedJobComment::updateOrCreate(
            ['staff_requistion_forms_id' => $validated['staff_requistion_forms_id']],
            ['comment' => $validated['comment'], 'user_id' =>$validated['user_id']]
        );

        return to_route('bpartner.pncapprovedrequistions.index')->with('message','Successfully Published');
    }
